...
const customThumbnail = inp =>{
	...
	<div class="yt-img-container" style="background-image: url('${inp.thumbnail}');"></div>
	...
	qs('#'+inp.id).onclick = ev =>{
		...
		setTimeout(()=>{
			...
			qs('.coverThumbnail').classList.add('coverThumbnail1');
			qs('.yt-img-container').classList.add('coverThumbnail1');
